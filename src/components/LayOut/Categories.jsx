  ...
  return (
    <section className="relative px-6 py-12">
      <div className="max-w-6xl mx-auto">
        {/* Heading */}
        <div className="mb-8">
          <h2 className="text-sm text-center font-extrabold italic text-black uppercase">
            Food Category
          </h2>
          <p className="text-black text-3xl font-extrabold text-center uppercase mt-4">
        ...
        <div className="absolute top-6 right-8 z-20 flex items-center gap-3">
          ...
          <button className="swiper-button-next-custom bg-orange-600 text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-red-700">
            <ChevronRight />
          </button>
        </div>
          ...
          {categories.map((cat, index) => (
            <SwiperSlide key={index}>
              <div
                ...
                className="bg-[#f7f2e2] rounded-xl p-4 flex flex-col items-center justify-center shadow-sm hover:shadow-md hover:scale-105 transition-all duration-500 cursor-pointer"
              >
