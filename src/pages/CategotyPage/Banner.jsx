...
const Banner = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://cdn.pixabay.com/photo/2019/09/12/18/29/street-cafe-4472312_1280.jpg')",
      }}
    >
      {/* Overlay */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-32">
        <Link to="/">
          <p
            className="uppercase tracking-[4px] text-sm text-gray-300"
            data-aos="fade-right"
          >
            Home
          </p>
        ...
        {/* Dynamic heading */}
        <h1
          className="text-5xl sm:text-6xl font-extrabold mt-2 mb-4 capitalize"
          data-aos="fade-right"
        >
          Category {name && <span className="text-red-600">{name}</span>}
        </h1>
